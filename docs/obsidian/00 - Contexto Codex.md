...
As Etapas 0A, 0B, 1A, 1B, 1C, 1D, 2A e 2B foram concluídas. A fundação em Next.js está publicada no repositório GitHub público `lucascout1010k/organizador-missoes`, com a branch principal `main`.
